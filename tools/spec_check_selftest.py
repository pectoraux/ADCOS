...
COPY_ITEMS: List[str] = ["spec", "tools", ".github", "protocol", "identity", "capabilities", "discovery", "topology", "resources", "intent", "policy", "routing", "sessions", "multipath", "mobility", "federation", "README.md", ".gitignore"]
