"""ADCOS backhaul adapter serialization (WORK-022).

Canonical-JSON serialization for the backhaul boundary's
...
excluded from canonical state; mirrors the WORK-018/019/021
