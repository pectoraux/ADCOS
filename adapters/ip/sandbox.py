...
from .contract import IPIntegrationContext, IPIntegrationContract, _BudgetExhausted
...
class SandboxedIPIntegration:
    ...
    def translate_v4(
        self, instant, session_reader, topology_reader, *,
        packet_view: PacketView, nat_policy: NATPolicy,
    ) -> OperationOutcome:
        return self._mediate(
            "translate_v4", instant, session_reader, topology_reader,
            lambda ctx: self._implementation.translate_v4(
