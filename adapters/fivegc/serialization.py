"""ADCOS 5G Core integration serialization (WORK-019).

Canonical-JSON serialization for the 5G Core integration boundary's
...
excluded from canonical state; mirrors the WORK-018 IP integration
discipline).  No vendor SDK, no crypto, no randomness.
"""
